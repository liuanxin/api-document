...
[[https://github.com/liuanxin/api-document-example][示例项目(spring boot 3)]]
...
PS: 可以参考 [[https://github.com/liuanxin/api-document-example][示例项目(spring boot 3)]] 的全局处理.
