...
refer to the global processing of [[https://github.com/liuanxin/api-document-example-en][example]]).
...
@ApiReturn  --> in field
  ...
  example   --> return example. only used on types where the field is a String
