...
swagger-ui view response instructions need to be swtich. Think of your branis as a computer, and your eyes as input devices,
When you see the returned json, the eyeball will parse itself into the corresponding object. At this time,
