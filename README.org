...
[[https://github.com/liuanxin/api-document-example-en][Example project(spring boot 4)]]
...
PS: You can refer to the global processing of [[https://github.com/liuanxin/api-document-example-en][example project(spring boot 4)]].
